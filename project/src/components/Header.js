  ...
  return (
    ...
    <div className=' bg fixed top-0 w-full py-2 px-4 h-16 text-center flex justify-between items-center bg-primary/95 text-white z-50'>
      <div className='flex space-x-3 items-center'>
        ...
        <a href="mailto:founders@hyperbound.ai" className="underline text-white "> founders@EchoAI</a>
        </p>
      </div>
      <div className='flex space-x-3 '>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-check w-4 h-4 mr-2"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="m9 16 2 2 4-4"></path></svg><p className=''> <Link to="/"> Book a demo to build your own bots</Link></p>
        </button>
      </div>
    </div>
      <div className=''></div>
